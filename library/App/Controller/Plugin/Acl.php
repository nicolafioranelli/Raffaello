...
class App_Controller_Plugin_Acl extends Zend_Controller_Plugin_Abstract
{
    ...
    public function __construct()
    {
        ...
        $ruolo = "non definito"; //valore che non serve a niente, solo di inizializzazione
        if(null !== $this->_auth->getIdentity()){
            $ruolo = $this->_auth->getIdentity()->current()->ruolo;
        }

        $this->_role = !$this->_auth->hasIdentity() ? 'public' : $ruolo;
